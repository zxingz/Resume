...
\section{Experience (3 Year 4 Months)}

\runsubsection{Scotiabank}
\descript{}
\descript{Full Stack Developer | International Banking Analytics}
...
\item Develop platform to manage large volumes of pricing and insurance data.
\end{tightemize}
\#\custombold{Microservices}  \#\custombold{DC/OS}  \#\custombold{Spark} \#\custombold{Machine Learning}  \#\custombold{APIs}  \#\custombold{Data Visualization}
\sectionsep
